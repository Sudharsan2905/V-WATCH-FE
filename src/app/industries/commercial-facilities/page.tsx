...
import { commercialFacilitiesContent } from "@/data/industries/commercial-facilities";

export default function CommercialFacilitiesPage() {
  const {
    hero,
    challenges,
    onePlatform,
