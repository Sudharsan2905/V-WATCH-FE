      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-[60px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_407px_1fr] gap-[20px] lg:gap-[30px] items-center">
          ...
          <div className="w-full max-w-[360px]">
            <p className="font-bold text-[15px] lg:text-[18px] text-[#1d6c97] mb-[20px] leading-[30px]">
          ...
          <div className="hidden lg:flex justify-center items-center">
            <div className="relative w-[407px] h-[455px] overflow-hidden">
              ...
              <div className="absolute left-0 top-[192px] w-[236px] h-[226px]">
                <Image src="/about/what-we-see-center-bottom.png" alt="" fill className="object-contain" sizes="236px" />
              </div>
              ...
              {/* Eye circle (top-left) — same structure/size as the worker circle below */}
              <div
              ...
              >
                ...
                {/* Eye icon — Group.svg counterpart */}
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/eye-icon.svg"
                  alt="Vision"
          ...
          {/* RIGHT COLUMN */}
          <div className="w-full max-w-[360px]">
            <p className="font-bold text-[15px] lg:text-[18px] text-[#1d6c97] leading-[30px]">
              This creates blind spots.
            </p>
            <p className="text-[15px] lg:text-[18px] text-[#1d6c97] leading-[30px] mt-[4px]">
              Teams struggle to
            </p>
                ...
                <div key={i} className="flex items-center gap-[10px]">
                  <div className="size-[20px] bg-[#fe5768] rounded-[10px] border-[0.667px] border-white flex-shrink-0 flex items-center justify-center shadow-[2.667px_2px_0px_rgba(255,142,142,0.25)]">
                    <div className="relative size-[10.667px]">
                      <Image
                        src="/about/what-we-see-icon-x.png"
                        alt=""
                        fill
                        className="object-contain"
                        sizes="11px"
