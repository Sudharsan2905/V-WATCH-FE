...
function FeatureCard({
  ...
  return (
    <motion.div variants={scaleIn} className="flex flex-col pt-8 gap-0">
      {/* Icon — overlaps the top-left corner of the card */}
      <div className="z-10 size-[55px]">
        {iconSrc && (
          <Image
            src={iconSrc}
            alt=""
      ...
      <div
        className="rounded-2xl border border-white/80 bg-white/70 px-4 pb-4 pt-4 backdrop-blur-sm"
...
export default function ConnectedTo() {
  return (
    <MotionConfig reducedMotion="user">
      <section className="relative overflow-hidden px-6 py-16 lg:px-[60px]">
        ...
        />
        <div className="relative mx-auto flex w-full max-w-[1410px] flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-16">
          {/* Left — hub diagram */}
          <motion.div
            initial="hidden"
            whileInView="show"
