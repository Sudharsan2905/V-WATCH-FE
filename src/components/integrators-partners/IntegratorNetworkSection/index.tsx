...
function DoubleChevron() {
  return (
    ...
    >
      <path
        d="M31.7607 11.0321L22.1508 0.354497C21.9458 0.128131 21.6597 0 21.3564 0H14.9498C14.7436 0.000223511 14.5417 0.05999 14.3686 0.172121C14.1955 0.284252 14.0584 0.443979 13.9739 0.632116C13.803 1.01865 13.8735 1.46924 14.1554 1.78103L23.1225 11.7454L14.1554 21.7076C13.8735 22.0216 13.8009 22.4722 13.9739 22.8565C14.1469 23.2431 14.5291 23.4908 14.9498 23.4908H21.3564C21.6597 23.4908 21.9458 23.3605 22.1508 23.1384L31.7607 12.4608C32.1259 12.0551 32.1259 11.4357 31.7607 11.0321Z"
        fill="currentColor"
      />
      <path
        d="M17.8798 11.0321L8.26996 0.354497C8.06495 0.128131 7.77879 0 7.47555 0H1.06896C0.862702 0.000223511 0.660889 0.05999 0.487768 0.172121C0.314647 0.284252 0.177579 0.443979 0.0930284 0.632116C-0.0778137 1.01865 -0.00734136 1.46924 0.274548 1.78103L9.24163 11.7454L0.274548 21.7076C-0.00734136 22.0216 -0.0799493 22.4722 0.0930284 22.8565C0.266006 23.2431 0.648265 23.4908 1.06896 23.4908H7.47555C7.77879 23.4908 8.06495 23.3605 8.26996 23.1384L17.8798 12.4608C18.245 12.0551 18.245 11.4357 17.8798 11.0321Z"
        fill="currentColor"
        fillOpacity="0.4"
      />
    </svg>
...
// Shared frosted-panel chrome for the detail view. Rendered on the right as a
// column on desktop, and inline beneath the selected card on mobile.
const PANEL_CLASS =
  "relative flex w-full flex-col overflow-hidden rounded-[32px] border-2 border-white bg-[linear-gradient(rgba(255,255,255,0.2),rgba(255,255,255,0.2)),linear-gradient(rgba(212,240,255,0.14),rgba(212,240,255,0.14))] p-5 shadow-[0_13px_24px_rgba(92,183,232,0.1),6px_10px_23px_rgba(245,248,255,0.2)]";

// Animated detail content (description, capabilities checklist, country map)
// for the currently selected integrator.
function PanelInner({ current }: Readonly<{ current: Integrator }>) {
  return (
    ...
    <MotionConfig reducedMotion="user">
      <section className="relative overflow-hidden px-6 pb-20 lg:px-[60px]">
        ...
        >
            ...
            {INTEGRATORS.map((integrator, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={isActive ? "text-white" : "text-[#B8E6FF]"}
                  >
                    <DoubleChevron />
                  </span>
                </motion.button>
                ...
                {/* Mobile: detail panel renders inline directly beneath the
                    selected card so capabilities sit under the chosen
                    integrator. Hidden on desktop in favor of the right column. */}
          ...
          {/* Detail panel — desktop only; on mobile it renders inline beneath
