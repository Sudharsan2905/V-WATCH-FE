...
export default function StepProcess() {
  ...
  useMotionValueEvent(scrollYProgress, "change", (progress) => {
    ...
    const reachedStep = STEP_THRESHOLDS.filter((threshold) => clamped >= threshold).length;
    setActive(reachedStep);
  });
    ...
    <MotionConfig reducedMotion="user">
      <section ref={sectionRef} className="px-6 pb-16 pt-2 lg:px-[60px]">
        <motion.div
          ...
          <div className="relative h-[200px] w-full sm:h-[260px] lg:absolute lg:inset-0 lg:h-full">
            <AnimatePresence>
              <motion.div
                key={step.image}
          ...
          {/* Content */}
          <div className="relative z-10 px-6 pb-8 pt-7 lg:max-w-[60%] lg:py-[56px] lg:pl-[175px] lg:pr-[60px]">
            {/* Heading + underline */}
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 pt-1">
                    ...
                    <p className="max-w-[420px] text-[15px] leading-[24px] text-white/70 sm:text-[16px]">
                      {step.body}
                    </p>
                  </div>
                </motion.div>
              ...
              {STEPS.map((s, i) => (
                <button
                  ...
                  className={`h-[8px] rounded-full transition-all duration-300 ${
                    i === active ? "w-[24px] bg-white" : "w-[8px] bg-white/30"
                  }`}
                />
              ))}
            </div>
