...
export default function Stats() {
  return (
    <section className="bg-white px-4 pb-20 sm:px-6 lg:px-[60px]">
      ...
      <div className="relative">
        ...
        <div
          className="absolute inset-x-0 top-10 hidden h-[286px] rounded-[31.56px] border border-[rgba(56,144,192,0.20)] sm:block lg:left-1/2 lg:right-auto lg:w-[999px] lg:-translate-x-1/2"
          style={{
        ...
        <div
          className="absolute inset-x-0 bottom-0 top-0 overflow-hidden rounded-[32px] border border-[rgba(255,255,255,0.20)] lg:left-1/2 lg:right-auto lg:w-[1061px] lg:-translate-x-1/2"
          style={{
            background: CARD_BG,
        ...
        <div className="relative z-[2] flex flex-col items-center gap-6 px-5 py-[26px]">
          {/* Heading + description */}
          <div className="flex w-full max-w-[845px] flex-col items-center gap-[10px]">
            <p
              className="text-center text-[20px] font-extrabold leading-7 text-[#F3FBFF] sm:text-[22px] lg:text-[26px] lg:leading-[32px]"
              style={{ wordWrap: "break-word" }}
            >
              Built for high-scale, high-complexity environments
            </p>
            <p
              className="self-stretch text-center text-[15px] font-medium leading-6 text-[#EBF7FE] sm:text-[17px] lg:text-[20px] lg:leading-[28px]"
              style={{ wordWrap: "break-word" }}
            >
              V-Watch Ai manages large volumes of users, tasks, and real-time
              data across complex environments ensuring reliability when it
              matters most.
            </p>
          </div>

          {/* Stats row — column on mobile, row on sm+ */}
          <div className="flex w-full flex-col items-center gap-6 sm:flex-row sm:justify-center sm:gap-[40px] lg:px-[140px]">
            {STATS.map((stat, i) => (
              <Fragment key={stat.label}>
                {i > 0 && (
                  <>
                    ...
                    <div className="h-px w-full bg-[rgba(212,240,255,0.20)] sm:hidden" />
                  </>
                )}
                <div className="flex w-full flex-col items-center gap-[10px] px-5 sm:flex-1">
                  {/* Icon circle */}
                  <div
                    className="inline-flex size-12 items-center justify-center rounded-full px-3"
                    style={{
                  ...
                  <div className="flex flex-col items-center gap-[6px] self-stretch">
                    <p
                      className="self-stretch text-center text-[28px] font-extrabold leading-[36px] text-white sm:text-[32px] lg:text-[36px] lg:leading-[42px]"
                      style={{ wordWrap: "break-word" }}
                    >
                      {stat.value}
                    </p>
                    <p className="text-center text-[13px] font-medium text-[#EFF9FF] sm:text-[14px] lg:text-[16px]">
                      {stat.label}
                    </p>
                  </div>
                </div>
