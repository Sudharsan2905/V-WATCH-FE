...
export default function UsedInEnvironments() {
  return (
    <MotionConfig reducedMotion="user">
      <section className="relative z-10">
        <div
          className="overflow-hidden rounded-t-[45px] px-6 py-12 sm:px-10 lg:px-15 lg:py-16"
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-[1320px]">
            ...
            >
              ...
              >
                Used in environments where safety is non-negotiable
              </motion.h2>
              <motion.p
                variants={fadeUp}
                custom={0.2}
                className="mt-3 max-w-[640px] text-[20px] font-normal leading-[28px] tracking-[0%] text-[#556394]"
              >
