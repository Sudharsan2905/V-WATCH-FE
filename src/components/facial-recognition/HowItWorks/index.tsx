...
const STEPS: {
...
}[] = [
  {
    ...
    title: "Enrol Worker Identities",
    description:
      "Each worker is registered with a facial scan linked to their profile, role, and access permissions — no cards or PINs required.",
  },
  {
    number: "02",
    icon: "/contractor-complaince/icons/02.svg",
    title: "Verify Identity at Entry Points",
    description:
      "Cameras at access points capture and match faces in real time — granting or denying entry in under a second.",
  },
  {
    number: "03",
    icon: "/contractor-complaince/icons/03.svg",
    title: "Enforce Zone-Based Access Rules",
    description:
      "Access permissions are tied to roles and zones — only authorised individuals can enter restricted or sensitive areas.",
  },
  {
    number: "04",
    icon: "/contractor-complaince/icons/04.svg",
    title: "Alert on Unauthorised Attempts",
    description: "Receive instant alerts for",
    bullets: [
      "Unrecognised individuals attempting entry",
      "Tailgating or forced-entry events",
      "Access attempts outside permitted hours",
    ],
  },
  {
    number: "05",
    icon: "/contractor-complaince/icons/05.svg",
    title: "Maintain a Full Access Audit Trail",
    description:
      "Every entry and exit is timestamped and logged — providing a complete, tamper-proof record for compliance and investigations.",
  },
];
          ...
          <div className="mt-10 flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-12">
            ...
            >
              <Image
                ...
                alt="Facial recognition access control workflow"
                fill
